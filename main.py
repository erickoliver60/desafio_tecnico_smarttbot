...
def main():
	...
	initial_date, ending_date = InputDate()	
	...
	if (conditionvalue == 'lastprice'):
		...
		new_df = LastDailyPriceDF(initial_date, ending_date, df)
		...
		new_df = MeanDailyPriceDF(initial_date, ending_date, df)
	
	#Media movel exponencial (MME)
	MME(initial_date, ending_date, new_df)
		
	#Índice de Força Relativa (IFR)
	#IFR(initial_date, ending_date, new_df)
			
	#Bandas de Bollinger
	Bollinger(initial_date, ending_date, new_df)
